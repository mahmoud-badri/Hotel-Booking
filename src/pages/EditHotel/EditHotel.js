    ...
    fetch(`http://127.0.0.1:8000/hotel/byOwner/${hotelId}`)
      ...
      .then(data => {
        ...
        setFormData({
          ...
          // Set other form fields with corresponding data
        })
...
//   useEffect(() => {
//     // Fetch initial hotel data
//     fetch(`http://127.0.0.1:8000/hotel/byOwner/${user.id}`)
//       .then(response => response.json())
...
const history=useHistory()
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(formData); 
//     const updatedHotel = {
//         id: hotelId, // Replace hotelId with the actual ID of the hotel to be edited
//         ...formData
//       };
//    await editHotel(updatedHotel); // Assuming addHotel is an asynchronous action
    //console.log(user)
