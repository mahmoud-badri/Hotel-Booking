...
import { getHotelReviews, postHotelReviews, putHotelReviews, deleteHotelReviews } from '../../Redux/HotelAction';
...
function ItemList(props){
    ...
    const list=props.itemlist.map((el)=>{ return(
...
function Icons(props){
    ...
    const list=props.iconlist.map((el)=>{ return(
...
function RoomFeatures(props){
    const roomImages=[ 
        ...
        "https://picsum.photos/id/1019/250/150/",
        "https://picsum.photos/id/1019/250/150/"
        ].map(el=><div className="col-md-3"><img src={el} className='w-100 m-0'/></div>)
...
function RoomTypes(props){
  ...
  return ( <div className="row text-dark my-3" style={{textAlign:"start"}}>
    <div className="col-md-3">
        <h3>
        Rooms Types
        </h3>
    ...
    <div className="col-md-9" >
        <RoomType title={"Single Room"} iconlist={roomIcons} itemlist={roomItems} />
        <RoomType title={"Double Room"} iconlist={roomIcons} itemlist={roomItems} />
    </div>
</div>)
}
    ...
    return(
        <div className='border-bottom border-1 border-dark py-2'>
            ...
            <div className="row d-flex  justify-content-between">
               ...
               <div className=''>
                    <img src={props.img} style={{width:"4vw", height:"4vw"}} className='rounded-circle' alt="" />
                </div>
        ...
        <Rating star={props.rate} icon={"star"} color1={"text-warning"} color2={"text-dark"} />
...
function Reviews(props){
    ...
    return(
           ...
           <div className="modal fade "  id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog ">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="staticBackdropLabel">Reviews</h5>
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                </div>
                <div className="modal-body">
                <form onSubmit={register.handleSubmit} className='text-start' >
        <label htmlFor="Name" > Name</label>
        <input  value={register.values.name} onChange={register.handleChange} type="text" name='name' id='Name' className='form-control mb-3' placeholder='Name' />
        ...
        <div className="modal-footer">
                    ...
                    <button type='submit'  className='btn bg-success text-white'>Add</button>
                </div>
        ...
        */}
        ...
        <Reviews />
                  ...
                  <div className="col-md-4  cc ">
                      ...
                      <p className='fs-4 icon-d'> <span className='sp-d'>Book</span> My Phone</p>
                      <p className='fs-5 phone-icon-d '>+456<span> </span>789<span> </span>0097</p>
